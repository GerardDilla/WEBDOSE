    ...
    async function getNotifications(){
        ...
        chat_notification.forEach((item)=>{
            ...
            <a href="#" class="notification-info">
                <div class="notification-student-name">${item.full_name}</div><div class="notification-student-message">${item.message}</div><span class="notification-time">5 hrs ago</span>
            </a>
            `;
        })
