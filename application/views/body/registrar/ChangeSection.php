			...
			<div class="col-md-4">
				...
				<form action="<?php echo base_url(); ?>index.php/Registrar/ChangeSection" method="post">
					<div class="SBorder vertical_gap">
						...
						echo form_dropdown('Semester', $options, $this->input->post('Semester'), $js);
						?>
						...
						echo form_dropdown('School_year', $options, $this->input->post('School_year'), $js);
						?>
