        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h2 class="modal-title" id="defaultModalLabel">Update User Account</h2>
                </div>
                <div class="modal-body" style="padding-right: 100px; padding-left: 100px;">
                        <form id="update_account" action="<?= base_url('index.php/UserAccessibility/updateAccountSubmit');?>" method="POST">
                            <div class="msg"></div>
                                <div class="input-group useridUPDATE-div">
                                        <span class="input-group-addon">
                                            <i class="material-icons">format_list_numbered</i>
                                        </span>
                                        <div class="form-line"> 
                                ...
                                <div class="input-group fullnameUPDATE-div">
                                        <span class="input-group-addon">
                                            <i class="material-icons">person</i>
                                        </span>
                                        <div class="form-line">
                                ...
                                <div class="input-group usernameUPDATE-div">
                                        <span class="input-group-addon">
                                            <i class="material-icons">account_box</i>
                                        </span>
                                        <div class="form-line">
                                ...
                                <div class="input-group departmentUPDATE-div">
                                        <span class="input-group-addon">
                                            <i class="material-icons">group_work</i>
                                        </span>
                                        <div class="form-line">
                                ...
                                <div class="input-group positionUPDATE-div">
                                        <span class="input-group-addon">
                                            <i class="material-icons">grade</i>
                                        </span>
                                        <div class="form-line">
                                ...
                                <div class="input-group passwordUPDATE-div">
                                        <span class="input-group-addon">
                                            <i class="material-icons">lock</i>
                                        </span>
                                        <div class="form-line">
                                            <label class="form-label">Password (NOTE:Leave this empty if you dont need to change password.)</label>
                                ...
                                <div class="input-group accessTypeUPDATE-div">
                                    <div class="input-group">
                                        <span class="input-group-addon">
                                ...
                                <div class="input-group tabValidUPDATE-div">
                                    <span class="input-group-addon">
                        ...
                        <div class="modal-body" style="padding-right: 100px; padding-left: 100px;">
                                <form id="account_creation" action="<?= base_url('index.php/UserAccessibility/createAccountSubmit');?>" method="POST">
                                    <div class="msg"></div>
                                        ...
                                        <div class="input-group fullname-div">
                                                <span class="input-group-addon">
                                                    <i class="material-icons">person</i>
                                                </span>
                                                <div class="form-line">
                                        ...
                                        <div class="input-group accessType-div">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                        <i class="material-icons">accessibility</i>
                                                </span>
            ...
            async function initUserTable(data){
                ...
                data.forEach(row => {
                    ...
                    html += `<tr>
                                ...
                                <th class="text-center">${row.tabValid==0?'No':'Yes'}</th>
                                <th class="text-center">
