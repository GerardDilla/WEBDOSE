    ...
    <div class="container-fluid">
        ...
        <div class="row clearfix">
			<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
				<div class="card">
					<div class="header">
						<h2 class="red"> Higher Education Enrollment payment</h2>     
					</div>  
					<br>
					...
					<div class="body"><!--start div Body-->
						...
						<br>
						<?php endIf; ?>
						<form method="post" id="selectStudentForm" action="<?php echo site_url(); ?>/Cashier">
						...
						<div class="row">
							...
							<div class="col-md-2">
								<div class="input-group">
									<b class="red">Please Select Semester:</b>
							...
							<div class="col-md-2">
								<button class="btn btn-danger btn-lg" id="selectStudentSubmit" name="" type="submit">SEARCH</button>
							</div>
						...
						<div class="tab-content">
							<div role="tabpanel" class="tab-pane fade active in" id="tab_student_info">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											<b class="black">Course:</b>
											<input type="text" disabled class="form-control InfoEnabled" value="<?php echo $student_info['Course'];  ?>" >
											
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-line">
											<b class="black">Year Level:</b>
											<input type="text" disabled class="form-control InfoEnabled" value="<?php echo $student_info['YearLevel'];  ?>" >
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											<b class="black">Admitted Semester:</b>
											<input type="text" disabled class="form-control InfoEnabled" value="<?php echo $student_info['AdmittedSEM'];  ?>" >
							...
							<form method="post" id="insertReservation" action="<?php echo site_url(); ?>/Cashier/hed_reservation">
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											<b class="black">Selected Semester:</b>
											<input type="text" id="semesterRes" name="semester" readonly class="form-control InfoEnabled" value="<?php echo $this->data['semester'];  ?>" >
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											<button class="btn btn-danger" id="reservationInsertButton"> Insert </button>
										</div>
									</div>
								</div>
							...
							<form method="post" id="insertMatriculation" action="<?php echo site_url(); ?>/Cashier/hed_matriculation_input">
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											<b class="black">Selected Semester:</b>
											<input type="text" id="semester" name="semester" readonly class="form-control InfoEnabled" value="<?php echo $this->data['semester'];  ?>" >
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											...
											<input type="text"  disabled class="form-control InfoEnabled" value="<?php echo $this->data['total_payment'][0]['total_payment'];  ?>" >
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-line">
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											...
											<input type="text"  disabled class="form-control InfoEnabled" value="<?php $payment_scheme = ($fees_enrolled['fullpayment'] == 1) ? "FULL PAYMENT" : "INSTALLMENT" ; echo $payment_scheme;  ?>" >
										</div>
									</div>
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											...
											<input type="text"  disabled class="form-control InfoEnabled" value="<?php echo $fees_enrolled['InitialPayment'];  ?>" >
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-line">
											<b class="black">First Payment:</b>
											<input type="text"  disabled class="form-control InfoEnabled" value="<?php echo $fees_enrolled['First_Pay'];  ?>" >
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											...
											<input type="text"  disabled class="form-control InfoEnabled" value="<?php echo $fees_enrolled['Second_Pay'];  ?>" >
										</div>
									</div>
									<div class="col-md-4">
										<div class="form-line">
											<b class="black">Third Payment:</b>
											<input type="text"  disabled class="form-control InfoEnabled" value="<?php echo $fees_enrolled['Third_Pay'];  ?>" >
								...
								<div class="row">
									<div class="col-md-4">
										<div class="form-line">
											<button class="btn btn-danger" id="matriculationInsertButton"> Insert </button>
										</div>
									</div>
								</div>
								<?php endif; ?>
