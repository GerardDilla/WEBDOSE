...
<div class="row clearfix">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="card">
                        <div class="header">
                        <h2> Senior High School Student Information</h2> 
                        </div>
                        <div class="body">
                            <!-- Nav tabs -->
                            ...
                            <?php if($this->session->flashdata('noref')): ?>
                                    ...
                                    <?php endif; ?>
                     <form id="sign_up" action="<?php echo base_url(); ?>index.php/Admission/Student_Info_SHS"  method="POST">
                            <div class="row">
                                    ...
                                    <div class="col-md-5">
                                       <div class="pull-right">
                                        <button type="button" onclick="window.open(`<?php echo base_url(); ?>index.php/Admission/SHS_inquiryExport/<?= $this->data['get_info'][0]['Reference_Number'];?>`,'_blank','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=800,height=600')" class="btn btn-info btn-lg">EXPORT APPLICATION FORM</button>&nbsp;<button name="edit"  type="button" onclick="disable()" class="btn btn-success btn-lg EditButton">EDIT</button>
                                        <br>
