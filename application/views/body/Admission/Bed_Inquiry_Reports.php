                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        ...
                                        <!-- <td><a href="<?php echo base_url(); ?>index.php/Admission/BED_inquiryExport/<?php echo $row->ref_no; ?>" class="btn btn-info btn-sm">Export Application Form</a></td> -->
                                        <td><button type="button" onclick="window.open(`<?php echo base_url(); ?>index.php/Admission/BED_inquiryExport/<?php echo $row->ref_no; ?>`,'_blank','directories=no,titlebar=no,toolbar=no,location=no,status=no,menubar=no,scrollbars=no,resizable=no,width=800,height=600')" class="btn btn-info btn-sm">Export Application Form</button></td>
