...
.modal-content {
  ...
  <section class="content">
                        ...
                        <div class="card">
                            ...
                            <div class="body">
                               <div class="chart-wrapper" id='printMe1'>
                                  ...
                                  <span  style="font-weight: 900;">Total:</span><div class="TotalAllInquiryStudents">  </div>
                               </div>
                            </div>
                        </div>
                            ...
                            <div class="body">
                              <div class="chart-wrapper" id='printMe2'>
                                <canvas id="myCharts3" width="1000" height="800"></canvas>
                                 <span  style="font-weight: 900;">Total:</span><div class="TotalAllReserveStudents">  </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="body">
                                <div class="chart-wrapper" id='printMe4'>
                                    <canvas id="myCharts5" width="1000" height="800"></canvas>
                                     <span  style="font-weight: 900;">Total:</span><div class="TotalNEWStudents"> 240 </div>
                                </div>    
                            </div>
                        </div>
    ...
    <div class="modal" id="largeModal" tabindex="-1" role="dialog">
            ...
            <div class="modal" id="largeModal2" tabindex="-1" role="dialog" style="width100%; height:100%;">
                <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
