...
//Checker if blank or Unknown Reference/Student Number
  ...
  //Checker if blank or Unknown Reference/Student Number
    ...
    public function NewStudentExcel(){
      ...
      $employee_data = $this->New_Students_Model->Get_New_Students($array);
      ...
      foreach($employee_data as $row)
      {
       ...
       $object->getActiveSheet()->setCellValueByColumnAndRow(7, $excel_row,  $row['YLF']);
       ...
       $object->getActiveSheet()->setCellValueByColumnAndRow(10, $excel_row,  $row['Transferee_Name']);  
    ...
    public function enrollment_summary_excel($seperate,$tab){
      ...
      foreach($seperate as $laman){
        ...
        if ($laman['Others_Know_SDCA'] == 'Come_All') {
          $object->getActiveSheet()->setCellValueByColumnAndRow(13, $excel_row,  strtoupper(
    ...
    public function summary_excel($seperate,$tab){
      ...
      foreach($seperate as $laman){
        ...
        if ($laman['Others_Know_SDCA'] == 'Come_All') {
          $object->getActiveSheet()->setCellValueByColumnAndRow(9, $excel_row,  strtoupper(
            $laman['Others_Know_SDCA']." Referral Name: ".$laman['Referral_Name']
            )
          );
        } else {
